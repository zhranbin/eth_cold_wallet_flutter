...
class DBHelper {
  ...
  // 查询数据
  static Future<List<Map<String, dynamic>>> query(String table, {String? where, String? orderBy}) async {
    final db = await database;
    return db.query(table, where: where, orderBy: orderBy);
  }

  // 更新数据
  static Future<int> update(String table, Map<String, dynamic> values, {String? where}) async {
    final db = await database;
